...
export default function PrivacyPolicy() {
  ...
  const privacyContent = settings?.pages?.privacy_content;
    ...
    <div className="w-full px-6 sm:px-10 lg:px-16 xl:px-24 py-12 max-w-3xl mx-auto min-h-screen animate-in fade-in duration-500">
      <div className="space-y-12">
        ...
        <ScrollArea className="h-[calc(100vh-300px)] pr-6 -mr-6">
          <div className="space-y-10 text-[13px] leading-relaxed text-muted-foreground/90 whitespace-pre-wrap">
            {privacyContent ? (
              <div className="font-sans text-sm leading-relaxed whitespace-pre-wrap">{privacyContent}</div>
            ) : (
              <>
